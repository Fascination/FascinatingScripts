...
public class sapNecklace extends Node{
	...
	public boolean activate() {
		...
		if(Variables.necklace == true){
			return true;
		}
		
		return !Methods.isSlotEmpty(2); 
	}
	@Override
	public void execute() {
		
if(Variables.neckToEnchant == Variables.sapNecklace){
			
			final WidgetChild widget = Widgets.get(WIDGET_TEXT,
					WIDGETCHILD_TEXT).getChild(0);
			
			final Item sapItem = Inventory.getItem(Variables.sapNecklace);
			if(sapItem != null){
