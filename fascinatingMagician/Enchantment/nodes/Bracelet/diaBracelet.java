...
public class diaBracelet extends Node{
	...
	public boolean activate() {
		...
		return !Methods.isSlotEmpty(5);
	}
	@Override
	public void execute() {
	
		if(Variables.braceToEnchant == Variables.diaBracelet){
			
			final WidgetChild widget = Widgets.get(WIDGET_TEXT,
					WIDGETCHILD_TEXT).getChild(0);
			
			final Item sapItem = Inventory.getItem(Variables.diaBracelet);
			if(sapItem != null){
